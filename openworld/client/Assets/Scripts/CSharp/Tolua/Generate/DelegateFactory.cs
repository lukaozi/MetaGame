...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<enScheduleOverType,SimpleSchedule>), factory.System_Action_enScheduleOverType_SimpleSchedule);
		...
		DelegateTraits<System.Action<enScheduleOverType,SimpleSchedule>>.Init(factory.System_Action_enScheduleOverType_SimpleSchedule);
		...
		TypeTraits<System.Action<enScheduleOverType,SimpleSchedule>>.Init(factory.Check_System_Action_enScheduleOverType_SimpleSchedule);
		...
		StackTraits<System.Action<enScheduleOverType,SimpleSchedule>>.Push = factory.Push_System_Action_enScheduleOverType_SimpleSchedule;
	}
	...
	class System_Action_enScheduleOverType_SimpleSchedule_Event : LuaDelegate
	{
		public System_Action_enScheduleOverType_SimpleSchedule_Event(LuaFunction func) : base(func) { }
		public System_Action_enScheduleOverType_SimpleSchedule_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(enScheduleOverType param0, SimpleSchedule param1)
		{
			func.BeginPCall();
			func.Push(param0);
		...
		public void CallWithSelf(enScheduleOverType param0, SimpleSchedule param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public System.Action<enScheduleOverType,SimpleSchedule> System_Action_enScheduleOverType_SimpleSchedule(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<enScheduleOverType,SimpleSchedule> fn = delegate(enScheduleOverType param0, SimpleSchedule param1) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_enScheduleOverType_SimpleSchedule_Event target = new System_Action_enScheduleOverType_SimpleSchedule_Event(func);
			System.Action<enScheduleOverType,SimpleSchedule> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_enScheduleOverType_SimpleSchedule_Event target = new System_Action_enScheduleOverType_SimpleSchedule_Event(func, self);
			System.Action<enScheduleOverType,SimpleSchedule> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_enScheduleOverType_SimpleSchedule(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<enScheduleOverType,SimpleSchedule>), L, pos);
	}

	void Push_System_Action_enScheduleOverType_SimpleSchedule(IntPtr L, System.Action<enScheduleOverType,SimpleSchedule> o)
	{
		ToLua.Push(L, o);
	}
