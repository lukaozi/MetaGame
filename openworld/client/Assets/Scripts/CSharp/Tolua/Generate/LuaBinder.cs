...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		LuaMgrBridgeWrap.Register(L);
		EnterLuaScheduleWrap.Register(L);
		SingletonMonoBehaviour_LuaMgrBridgeWrap.Register(L);
		SimpleScheduleWrap.Register(L);
		...
		L.RegFunction("Action_enScheduleOverType_SimpleSchedule", System_Action_enScheduleOverType_SimpleSchedule);
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_enScheduleOverType_SimpleSchedule(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<enScheduleOverType,SimpleSchedule>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<enScheduleOverType,SimpleSchedule>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
